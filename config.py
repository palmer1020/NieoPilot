...
ROTATION_NIEO_RIGHT_CLICKS_FLIGHT = 40
ROTATION_NIEO_RIGHT_CLICKS_WATER = 20
ROTATION_NIEO_RIGHT_CLICKS_GRASS = 40
ROTATION_NIEO_RIGHT_CLICKS_LIGHT = 40
ROTATION_NIEO_RIGHT_CLICKS_PSYCHIC = 80
ROTATION_NIEO_RIGHT_CLICKS_NORMAL = 80
ROTATION_NIEO_RIGHT_CLICKS_ICE = 80
...
GAME_GROUP_FIGHT_FLY_PET_SWF_DIR = os.path.join(
    GAME_ASSET_BASE_PATH, "groupFightResource", "flyPet"
)
...
GAME_NEWNPC_MULTI_DIR = os.path.join(GAME_ASSET_BASE_PATH, "newNpc", "multi")
